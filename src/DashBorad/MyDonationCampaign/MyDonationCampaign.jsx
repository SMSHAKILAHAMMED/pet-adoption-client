...
const MyDonationCampaign = () => {
  ...
  return (
    <div className="container mx-auto">
       <Helmet>
        <title>Pet Adoption | My Donation Campaign</title>
      </Helmet>
      <h1 className="text-4xl font-extrabold text-center mb-5">My Donation Campaign</h1>
      <table className="min-w-full bg-gray-100 border border-gray-200">
        <thead>
          <tr className="bg-sky-300 text-sm font-bold text-black">
