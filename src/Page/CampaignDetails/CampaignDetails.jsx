...
const CampaignDetails = () => {
  ...
  return (
    <div>
       <Helmet>
        <title>Pet Adoption | Campaign Details</title>
      </Helmet>
      <div>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mt-3 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
                <button
                  ...
                  className="btn bg-purple-500 text-white hover:text-black btn-sm"
                >
                  Donate Now
                </button> 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-10 mt-2">
            {recomendedData.slice(0, 3).map((campaign) => (
              <div key={campaign._id}>
                <div className="px-0 border  bg-slate-200 rounded-xl">
                  ...
                  <div className="px-5">
                    ...
                    <div className="w-full flex justify-end my-2 mb-3">
                      <Link to={`/campaignDetails/${campaign._id}`}>
                        <button className="rounded-md  btn-sm btn overflow-hidden relative group cursor-pointer border-2 font-medium border-fuchsia-400 text-black hover:text-black">
                          View Details
                        </button>
                      </Link>
                    </div>
