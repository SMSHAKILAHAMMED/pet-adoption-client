        ...
        <div className="max-w-[85rem] mx-auto md:p-5 border-2 border-t-0">
          <div className="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
            <div className="lg:col-span-4 items-center mt-10 lg:mt-0">
              <img
                className="w-screen h-screen pt-20 rounded-xl"
                src={details.img}
                alt="Image Loading.....!"
              />
            </div>
            <div className="lg:col-span-3 space-y-4 ">
              ...
              <div className="flex justify-between border-b-2    items-center">
                ...
                <p className="mr-5 bg-blue-500 px-10   text-lg font-anton font-bold text-white dark:text-neutral-400">
                  age : {details.age}
                </p>
              </div>
              ...
              <p className="font-anton border-b-2">{details.short}</p>
              <p className="font-anton border-b-2">{details.long}</p>
              ...
              <div className="mt-3 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
                <button
                  ...
                  className="btn bg-sky-500  text-white hover:text-black  btn-sm px-10 hover:bg-[#fff] "
                >
                  Adopt
                </button>
                  ...
                  <div className="modal-box relative">
                    <form onSubmit={handleAdoptionREquest}>
                      ...
                      <div className="">
                        ...
                        <div>
                          <label htmlFor="expired">Create your Address :</label> <br />
                          <input
                            name="address"
                            type="text"
                            required
                            placeholder="create your address"
                            className="input input-bordered w-full"
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex justify-center my-5">
                        <button
                          type="submit"
                          className="btn btn-outline btn-primary px-5 text-white hover:text-black"
                        >
                          Submit
                        </button>
                      </div>
